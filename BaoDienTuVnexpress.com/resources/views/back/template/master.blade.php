...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{url('/')}}" class="nav-link" target="_blank">Xem wedsite</a>
      </li>
    </ul>
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        <a class="nav-link" data-toggle="dropdown" href="#">
          ...
          Xin chào: <b>{{Auth::user()->fullmane}}</b>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2021-2022 <a href="https://vnexpress.net/">Vnexpress</a>.</strong>
    All rights reserved.
...
<script >
  ...
  CKEDITOR.replace( 'ckeditor' ,{
    filebrowserBrowseUrl : '{!!url("public/responsive_filemanager/filemanager/dialog.php?type=2&editor=ckeditor&fldr=")!!}',
    filebrowserUploadUrl : '{!!url("public/responsive_filemanager/filemanager/dialog.php?type=2&editor=ckeditor&fldr=")!!}',
    filebrowserImageBrowseUrl : '{!!url("public/responsive_filemanager/filemanager/dialog.php?type=2&editor=ckeditor&fldr=")!!}'
  });
</script>
